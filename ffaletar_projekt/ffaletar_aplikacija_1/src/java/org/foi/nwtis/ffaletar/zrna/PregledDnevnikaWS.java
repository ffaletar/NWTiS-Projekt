 ...
 * @author Filip
 */
@Named(value = "pregledDnevnikaWS")
@SessionScoped
public class PregledDnevnikaWS implements Serializable {
    ...
    /**
     * Creates a new instance of PregledDnevnikaWS
     */
    public PregledDnevnikaWS() {
    ...
    public void preuzmiDnevnik() {
        ...
        dnevnikWS = db.dajDnevnik(0, pocetak, krajPregleda);
